 ...
 * =>
 * void swe_date_conversion(int year, int month, int day, double hour, int gregflag[, function callback (result)]) = {
 *   julianDay: double,
 *   error: string
 * }
 */
 ...
 * =>
 * int32 swe_utc_to_jd(int32 iyear, int32 imonth, int32 iday, int32 ihour, int32 imin, double dsec, int32 gregflag) {
 *   julianDayUT: double,
 *   julianDayET: double,
 *   error: string
 * }
 ...
 * =>
 * void swe_utc_time_zone(int32 iyear, int32 imonth, int32 iday, int32 ihour, int32 imin, double dsec, double d_timezone) = {
 *   year: int,
 *   month: int,
 *   day: int,
 *   hour: int,
