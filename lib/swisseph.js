...
swisseph.calc = function (options, callback) {
	...
	if (options.date.gregorian.hasOwnProperty ('terrestrial')) {
		...
		utils.merge (options.date.gregorian.universal, swisseph.swe_revjul (options.date.julian.universal, swisseph.SE_GREG_CAL));
	} else if (options.date.gregorian.hasOwnProperty ('universal')) {
		...
		utils.merge (options.date.gregorian.terrestrial, swisseph.swe_revjul (options.date.julian.terrestrial, swisseph.SE_GREG_CAL));
	} else if (options.date.julian.hasOwnProperty ('terrestrial')) {
		options.date.julian.delta = swisseph.swe_deltat (options.date.julian.terrestrial).delta;
		options.date.julian.universal = options.date.julian.terrestrial - options.date.julian.delta;
		options.date.gregorian.universal = options.date.gregorian.universal || {};
		options.date.gregorian.terrestrial = options.date.gregorian.terrestrial || {};
		utils.merge (options.date.gregorian.terrestrial, swisseph.swe_revjul (options.date.julian.terrestrial, swisseph.SE_GREG_CAL));
		utils.merge (options.date.gregorian.universal, swisseph.swe_revjul (options.date.julian.universal, swisseph.SE_GREG_CAL));
	} else if (options.date.julian.hasOwnProperty ('universal')) {
		options.date.julian.delta = swisseph.swe_deltat (options.date.julian.universal).delta;
		options.date.julian.terrestrial = options.date.julian.universal + options.date.julian.delta;
		options.date.gregorian.universal = options.date.gregorian.universal || {};
		options.date.gregorian.terrestrial = options.date.gregorian.terrestrial || {};
	...
	utils.merge (options.body.position, swisseph.swe_calc_ut (options.date.julian.universal, parseInt (options.body.id), flags));
